...
// Validate checks the field values on CgroupDisk with the rules defined in the
// proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *CgroupDisk) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on CgroupDisk with the rules defined in
// the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in CgroupDiskMultiError, or
// nil if none found.
func (m *CgroupDisk) ValidateAll() error {
	return m.validate(true)
}

func (m *CgroupDisk) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return CgroupDiskMultiError(errors)
	}

	return nil
}

// CgroupDiskMultiError is an error wrapping multiple validation errors
// returned by CgroupDisk.ValidateAll() if the designated constraints aren't met.
type CgroupDiskMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m CgroupDiskMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m CgroupDiskMultiError) AllErrors() []error { return m }

// CgroupDiskValidationError is the validation error returned by
// CgroupDisk.Validate if the designated constraints aren't met.
type CgroupDiskValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e CgroupDiskValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e CgroupDiskValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e CgroupDiskValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e CgroupDiskValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e CgroupDiskValidationError) ErrorName() string { return "CgroupDiskValidationError" }

// Error satisfies the builtin error interface
func (e CgroupDiskValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = CgroupDiskValidationError{}
...
// Validate checks the field values on ModelScope with the rules defined in the
// proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
...
// ValidateAll checks the field values on ModelScope with the rules defined in
// the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in ModelScopeMultiError, or
// nil if none found.
...
// ModelScopeMultiError is an error wrapping multiple validation errors
// returned by ModelScope.ValidateAll() if the designated constraints aren't met.
...
// ModelScopeValidationError is the validation error returned by
// ModelScope.Validate if the designated constraints aren't met.
