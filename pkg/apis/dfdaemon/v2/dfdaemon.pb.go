...
func (x *SyncPiecesResponse) GetHeader() map[string]string {
	if x != nil {
		return x.Header
	}
	return nil
...
func (x *DownloadTaskResponse) GetHeader() map[string]string {
	if x != nil {
		return x.Header
	}
	return nil
...
var file_pkg_apis_dfdaemon_v2_dfdaemon_proto_rawDesc = []byte{
	...
	0x64, 0x50, 0x69, 0x65, 0x63, 0x65, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x73, 0x22, 0xdc, 0x01,
	...
	0x20, 0x01, 0x28, 0x04, 0x52, 0x06, 0x6c, 0x65, 0x6e, 0x67, 0x74, 0x68, 0x12, 0x43, 0x0a, 0x06,
	0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2b, 0x2e, 0x64,
	0x66, 0x64, 0x61, 0x65, 0x6d, 0x6f, 0x6e, 0x2e, 0x76, 0x32, 0x2e, 0x53, 0x79, 0x6e, 0x63, 0x50,
	0x69, 0x65, 0x63, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x2e, 0x48, 0x65,
	...
	0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x5b, 0x0a, 0x14,
	...
	0x77, 0x6e, 0x6c, 0x6f, 0x61, 0x64, 0x22, 0xb0, 0x02, 0x0a, 0x14, 0x44, 0x6f, 0x77, 0x6e, 0x6c,
	...
	0x65, 0x65, 0x72, 0x49, 0x64, 0x12, 0x45, 0x0a, 0x06, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x18,
	0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2d, 0x2e, 0x64, 0x66, 0x64, 0x61, 0x65, 0x6d, 0x6f, 0x6e,
	...
	0x6e, 0x74, 0x72, 0x79, 0x52, 0x06, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x12, 0x30, 0x0a, 0x05,
	...
	0x42, 0x05, 0x8a, 0x01, 0x02, 0x10, 0x01, 0x52, 0x05, 0x70, 0x69, 0x65, 0x63, 0x65, 0x1a, 0x39,
...
var file_pkg_apis_dfdaemon_v2_dfdaemon_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_pkg_apis_dfdaemon_v2_dfdaemon_proto_goTypes = []interface{}{
	...
	nil,                                // 10: dfdaemon.v2.SyncPiecesResponse.HeaderEntry
	nil,                                // 11: dfdaemon.v2.DownloadTaskResponse.HeaderEntry
	(*v2.Download)(nil),                // 12: common.v2.Download
	(*v2.Piece)(nil),                   // 13: common.v2.Piece
	(*v2.Task)(nil),                    // 14: common.v2.Task
	(*emptypb.Empty)(nil),              // 15: google.protobuf.Empty
}
var file_pkg_apis_dfdaemon_v2_dfdaemon_proto_depIdxs = []int32{
	12, // 0: dfdaemon.v2.TriggerDownloadTaskRequest.download:type_name -> common.v2.Download
	10, // 1: dfdaemon.v2.SyncPiecesResponse.header:type_name -> dfdaemon.v2.SyncPiecesResponse.HeaderEntry
	13, // 2: dfdaemon.v2.DownloadPieceResponse.piece:type_name -> common.v2.Piece
	12, // 3: dfdaemon.v2.DownloadTaskRequest.download:type_name -> common.v2.Download
	11, // 4: dfdaemon.v2.DownloadTaskResponse.header:type_name -> dfdaemon.v2.DownloadTaskResponse.HeaderEntry
	13, // 5: dfdaemon.v2.DownloadTaskResponse.piece:type_name -> common.v2.Piece
	14, // 6: dfdaemon.v2.UploadTaskRequest.task:type_name -> common.v2.Task
	0,  // 7: dfdaemon.v2.DfdaemonUpload.TriggerDownloadTask:input_type -> dfdaemon.v2.TriggerDownloadTaskRequest
	1,  // 8: dfdaemon.v2.DfdaemonUpload.SyncPieces:input_type -> dfdaemon.v2.SyncPiecesRequest
	3,  // 9: dfdaemon.v2.DfdaemonUpload.DownloadPiece:input_type -> dfdaemon.v2.DownloadPieceRequest
	5,  // 10: dfdaemon.v2.DfdaemonDownload.DownloadTask:input_type -> dfdaemon.v2.DownloadTaskRequest
	7,  // 11: dfdaemon.v2.DfdaemonDownload.UploadTask:input_type -> dfdaemon.v2.UploadTaskRequest
	8,  // 12: dfdaemon.v2.DfdaemonDownload.StatTask:input_type -> dfdaemon.v2.StatTaskRequest
	9,  // 13: dfdaemon.v2.DfdaemonDownload.DeleteTask:input_type -> dfdaemon.v2.DeleteTaskRequest
	15, // 14: dfdaemon.v2.DfdaemonUpload.TriggerDownloadTask:output_type -> google.protobuf.Empty
	2,  // 15: dfdaemon.v2.DfdaemonUpload.SyncPieces:output_type -> dfdaemon.v2.SyncPiecesResponse
	4,  // 16: dfdaemon.v2.DfdaemonUpload.DownloadPiece:output_type -> dfdaemon.v2.DownloadPieceResponse
	6,  // 17: dfdaemon.v2.DfdaemonDownload.DownloadTask:output_type -> dfdaemon.v2.DownloadTaskResponse
	15, // 18: dfdaemon.v2.DfdaemonDownload.UploadTask:output_type -> google.protobuf.Empty
	14, // 19: dfdaemon.v2.DfdaemonDownload.StatTask:output_type -> common.v2.Task
	15, // 20: dfdaemon.v2.DfdaemonDownload.DeleteTask:output_type -> google.protobuf.Empty
