...
var file_pkg_apis_dfdaemon_v2_dfdaemon_proto_rawDesc = []byte{
	...
	0x6d, 0x62, 0x65, 0x72, 0x22, 0x58, 0x0a, 0x24, 0x44, 0x6f, 0x77, 0x6e, 0x6c, 0x6f, 0x61, 0x64,
	0x50, 0x65, 0x72, 0x73, 0x69, 0x73, 0x74, 0x65, 0x6e, 0x74, 0x43, 0x61, 0x63, 0x68, 0x65, 0x50,
	0x69, 0x65, 0x63, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x30, 0x0a, 0x05,
	0x70, 0x69, 0x65, 0x63, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x63, 0x6f,
	0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x76, 0x32, 0x2e, 0x50, 0x69, 0x65, 0x63, 0x65, 0x42, 0x08, 0xfa,
	0x42, 0x05, 0x8a, 0x01, 0x02, 0x10, 0x01, 0x52, 0x05, 0x70, 0x69, 0x65, 0x63, 0x65, 0x22, 0x55,
	...
	0x65, 0x65, 0x72, 0x49, 0x64, 0x32, 0xbf, 0x07, 0x0a, 0x0e, 0x44, 0x66, 0x64, 0x61, 0x65, 0x6d,
	...
	0x54, 0x61, 0x73, 0x6b, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x30, 0x01, 0x12, 0x66,
	...
	0x68, 0x65, 0x54, 0x61, 0x73, 0x6b, 0x12, 0x7c, 0x0a, 0x19, 0x53, 0x79, 0x6e, 0x63, 0x50, 0x65,
	...
	0x2e, 0x48, 0x6f, 0x73, 0x74, 0x30, 0x01, 0x32, 0xab, 0x06, 0x0a, 0x10, 0x44, 0x66, 0x64, 0x61,
	...
	0x65, 0x30, 0x01, 0x12, 0x44, 0x0a, 0x0a, 0x55, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x54, 0x61, 0x73,
	...
	0x62, 0x75, 0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x12, 0x39, 0x0a, 0x08, 0x53, 0x74, 0x61,
...
var file_pkg_apis_dfdaemon_v2_dfdaemon_proto_depIdxs = []int32{
	...
	17, // 22: dfdaemon.v2.DfdaemonUpload.SyncPersistentCachePieces:input_type -> dfdaemon.v2.SyncPersistentCachePiecesRequest
	19, // 23: dfdaemon.v2.DfdaemonUpload.DownloadPersistentCachePiece:input_type -> dfdaemon.v2.DownloadPersistentCachePieceRequest
	21, // 24: dfdaemon.v2.DfdaemonUpload.SyncHost:input_type -> dfdaemon.v2.SyncHostRequest
	0,  // 25: dfdaemon.v2.DfdaemonDownload.DownloadTask:input_type -> dfdaemon.v2.DownloadTaskRequest
	8,  // 26: dfdaemon.v2.DfdaemonDownload.UploadTask:input_type -> dfdaemon.v2.UploadTaskRequest
	9,  // 27: dfdaemon.v2.DfdaemonDownload.StatTask:input_type -> dfdaemon.v2.StatTaskRequest
	10, // 28: dfdaemon.v2.DfdaemonDownload.DeleteTask:input_type -> dfdaemon.v2.DeleteTaskRequest
	28, // 29: dfdaemon.v2.DfdaemonDownload.DeleteHost:input_type -> google.protobuf.Empty
	11, // 30: dfdaemon.v2.DfdaemonDownload.DownloadPersistentCacheTask:input_type -> dfdaemon.v2.DownloadPersistentCacheTaskRequest
	14, // 31: dfdaemon.v2.DfdaemonDownload.UploadPersistentCacheTask:input_type -> dfdaemon.v2.UploadPersistentCacheTaskRequest
	15, // 32: dfdaemon.v2.DfdaemonDownload.StatPersistentCacheTask:input_type -> dfdaemon.v2.StatPersistentCacheTaskRequest
	16, // 33: dfdaemon.v2.DfdaemonDownload.DeletePersistentCacheTask:input_type -> dfdaemon.v2.DeletePersistentCacheTaskRequest
	...
	18, // 41: dfdaemon.v2.DfdaemonUpload.SyncPersistentCachePieces:output_type -> dfdaemon.v2.SyncPersistentCachePiecesResponse
	20, // 42: dfdaemon.v2.DfdaemonUpload.DownloadPersistentCachePiece:output_type -> dfdaemon.v2.DownloadPersistentCachePieceResponse
	30, // 43: dfdaemon.v2.DfdaemonUpload.SyncHost:output_type -> common.v2.Host
	3,  // 44: dfdaemon.v2.DfdaemonDownload.DownloadTask:output_type -> dfdaemon.v2.DownloadTaskResponse
	28, // 45: dfdaemon.v2.DfdaemonDownload.UploadTask:output_type -> google.protobuf.Empty
	26, // 46: dfdaemon.v2.DfdaemonDownload.StatTask:output_type -> common.v2.Task
	28, // 47: dfdaemon.v2.DfdaemonDownload.DeleteTask:output_type -> google.protobuf.Empty
	28, // 48: dfdaemon.v2.DfdaemonDownload.DeleteHost:output_type -> google.protobuf.Empty
	13, // 49: dfdaemon.v2.DfdaemonDownload.DownloadPersistentCacheTask:output_type -> dfdaemon.v2.DownloadPersistentCacheTaskResponse
	...
	28, // 52: dfdaemon.v2.DfdaemonDownload.DeletePersistentCacheTask:output_type -> google.protobuf.Empty
