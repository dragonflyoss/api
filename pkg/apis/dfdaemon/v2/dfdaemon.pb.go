...
var file_pkg_apis_dfdaemon_v2_dfdaemon_proto_rawDesc = []byte{
	...
	0x42, 0x0c, 0x0a, 0x0a, 0x5f, 0x72, 0x65, 0x6d, 0x6f, 0x74, 0x65, 0x5f, 0x69, 0x70, 0x22, 0x9c,
	...
	0xbe, 0x0e, 0x0a, 0x0e, 0x44, 0x66, 0x64, 0x61, 0x65, 0x6d, 0x6f, 0x6e, 0x55, 0x70, 0x6c, 0x6f,
	...
	0x32, 0xdf, 0x07, 0x0a, 0x10, 0x44, 0x66, 0x64, 0x61, 0x65, 0x6d, 0x6f, 0x6e, 0x44, 0x6f, 0x77,
...
var file_pkg_apis_dfdaemon_v2_dfdaemon_proto_msgTypes = make([]protoimpl.MessageInfo, 42)
var file_pkg_apis_dfdaemon_v2_dfdaemon_proto_goTypes = []interface{}{
	...
	(*DownloadPersistentCacheTaskRequest)(nil),         // 22: dfdaemon.v2.DownloadPersistentCacheTaskRequest
	(*DownloadPersistentCacheTaskStartedResponse)(nil), // 23: dfdaemon.v2.DownloadPersistentCacheTaskStartedResponse
	(*DownloadPersistentCacheTaskResponse)(nil),        // 24: dfdaemon.v2.DownloadPersistentCacheTaskResponse
	(*UploadPersistentCacheTaskRequest)(nil),           // 25: dfdaemon.v2.UploadPersistentCacheTaskRequest
	(*UpdatePersistentCacheTaskRequest)(nil),           // 26: dfdaemon.v2.UpdatePersistentCacheTaskRequest
	(*StatPersistentCacheTaskRequest)(nil),             // 27: dfdaemon.v2.StatPersistentCacheTaskRequest
	(*DeletePersistentCacheTaskRequest)(nil),           // 28: dfdaemon.v2.DeletePersistentCacheTaskRequest
	(*SyncPersistentCachePiecesRequest)(nil),           // 29: dfdaemon.v2.SyncPersistentCachePiecesRequest
	(*SyncPersistentCachePiecesResponse)(nil),          // 30: dfdaemon.v2.SyncPersistentCachePiecesResponse
	(*DownloadPersistentCachePieceRequest)(nil),        // 31: dfdaemon.v2.DownloadPersistentCachePieceRequest
	(*DownloadPersistentCachePieceResponse)(nil),       // 32: dfdaemon.v2.DownloadPersistentCachePieceResponse
	(*SyncHostRequest)(nil),                            // 33: dfdaemon.v2.SyncHostRequest
	(*IBVerbsQueuePairEndpoint)(nil),                   // 34: dfdaemon.v2.IBVerbsQueuePairEndpoint
	(*ExchangeIBVerbsQueuePairEndpointRequest)(nil),    // 35: dfdaemon.v2.ExchangeIBVerbsQueuePairEndpointRequest
	(*ExchangeIBVerbsQueuePairEndpointResponse)(nil),   // 36: dfdaemon.v2.ExchangeIBVerbsQueuePairEndpointResponse
	nil,                            // 37: dfdaemon.v2.DownloadTaskStartedResponse.ResponseHeaderEntry
	nil,                            // 38: dfdaemon.v2.ListTaskEntriesRequest.RequestHeaderEntry
	nil,                            // 39: dfdaemon.v2.ListTaskEntriesResponse.ResponseHeaderEntry
	nil,                            // 40: dfdaemon.v2.DownloadCacheTaskRequest.RequestHeaderEntry
	nil,                            // 41: dfdaemon.v2.DownloadCacheTaskStartedResponse.ResponseHeaderEntry
	(*v2.Download)(nil),            // 42: common.v2.Download
	(*v2.Range)(nil),               // 43: common.v2.Range
	(*v2.Piece)(nil),               // 44: common.v2.Piece
	(*durationpb.Duration)(nil),    // 45: google.protobuf.Duration
	(*v2.ObjectStorage)(nil),       // 46: common.v2.ObjectStorage
	(*v2.HDFS)(nil),                // 47: common.v2.HDFS
	(v2.TaskType)(0),               // 48: common.v2.TaskType
	(v2.Priority)(0),               // 49: common.v2.Priority
	(*emptypb.Empty)(nil),          // 50: google.protobuf.Empty
	(*v2.Task)(nil),                // 51: common.v2.Task
	(*v2.CacheTask)(nil),           // 52: common.v2.CacheTask
	(*v2.PersistentCacheTask)(nil), // 53: common.v2.PersistentCacheTask
	(*v2.Host)(nil),                // 54: common.v2.Host
}
var file_pkg_apis_dfdaemon_v2_dfdaemon_proto_depIdxs = []int32{
	42, // 0: dfdaemon.v2.DownloadTaskRequest.download:type_name -> common.v2.Download
	43, // 1: dfdaemon.v2.DownloadTaskStartedResponse.range:type_name -> common.v2.Range
	37, // 2: dfdaemon.v2.DownloadTaskStartedResponse.response_header:type_name -> dfdaemon.v2.DownloadTaskStartedResponse.ResponseHeaderEntry
	44, // 3: dfdaemon.v2.DownloadTaskStartedResponse.pieces:type_name -> common.v2.Piece
	44, // 4: dfdaemon.v2.DownloadPieceFinishedResponse.piece:type_name -> common.v2.Piece
	...
	44, // 7: dfdaemon.v2.DownloadPieceResponse.piece:type_name -> common.v2.Piece
	38, // 8: dfdaemon.v2.ListTaskEntriesRequest.request_header:type_name -> dfdaemon.v2.ListTaskEntriesRequest.RequestHeaderEntry
	45, // 9: dfdaemon.v2.ListTaskEntriesRequest.timeout:type_name -> google.protobuf.Duration
	46, // 10: dfdaemon.v2.ListTaskEntriesRequest.object_storage:type_name -> common.v2.ObjectStorage
	47, // 11: dfdaemon.v2.ListTaskEntriesRequest.hdfs:type_name -> common.v2.HDFS
	39, // 12: dfdaemon.v2.ListTaskEntriesResponse.response_header:type_name -> dfdaemon.v2.ListTaskEntriesResponse.ResponseHeaderEntry
	11, // 13: dfdaemon.v2.ListTaskEntriesResponse.entries:type_name -> dfdaemon.v2.Entry
	43, // 14: dfdaemon.v2.DownloadCacheTaskRequest.range:type_name -> common.v2.Range
	48, // 15: dfdaemon.v2.DownloadCacheTaskRequest.type:type_name -> common.v2.TaskType
	49, // 16: dfdaemon.v2.DownloadCacheTaskRequest.priority:type_name -> common.v2.Priority
	40, // 17: dfdaemon.v2.DownloadCacheTaskRequest.request_header:type_name -> dfdaemon.v2.DownloadCacheTaskRequest.RequestHeaderEntry
	45, // 18: dfdaemon.v2.DownloadCacheTaskRequest.timeout:type_name -> google.protobuf.Duration
	46, // 19: dfdaemon.v2.DownloadCacheTaskRequest.object_storage:type_name -> common.v2.ObjectStorage
	47, // 20: dfdaemon.v2.DownloadCacheTaskRequest.hdfs:type_name -> common.v2.HDFS
	43, // 21: dfdaemon.v2.DownloadCacheTaskStartedResponse.range:type_name -> common.v2.Range
	41, // 22: dfdaemon.v2.DownloadCacheTaskStartedResponse.response_header:type_name -> dfdaemon.v2.DownloadCacheTaskStartedResponse.ResponseHeaderEntry
	44, // 23: dfdaemon.v2.DownloadCacheTaskStartedResponse.pieces:type_name -> common.v2.Piece
	...
	44, // 26: dfdaemon.v2.DownloadCachePieceResponse.piece:type_name -> common.v2.Piece
	45, // 27: dfdaemon.v2.DownloadPersistentCacheTaskRequest.timeout:type_name -> google.protobuf.Duration
	23, // 28: dfdaemon.v2.DownloadPersistentCacheTaskResponse.download_persistent_cache_task_started_response:type_name -> dfdaemon.v2.DownloadPersistentCacheTaskStartedResponse
	2,  // 29: dfdaemon.v2.DownloadPersistentCacheTaskResponse.download_piece_finished_response:type_name -> dfdaemon.v2.DownloadPieceFinishedResponse
	45, // 30: dfdaemon.v2.UploadPersistentCacheTaskRequest.ttl:type_name -> google.protobuf.Duration
	45, // 31: dfdaemon.v2.UploadPersistentCacheTaskRequest.timeout:type_name -> google.protobuf.Duration
	44, // 32: dfdaemon.v2.DownloadPersistentCachePieceResponse.piece:type_name -> common.v2.Piece
	34, // 33: dfdaemon.v2.ExchangeIBVerbsQueuePairEndpointRequest.endpoint:type_name -> dfdaemon.v2.IBVerbsQueuePairEndpoint
	34, // 34: dfdaemon.v2.ExchangeIBVerbsQueuePairEndpointResponse.endpoint:type_name -> dfdaemon.v2.IBVerbsQueuePairEndpoint
	0,  // 35: dfdaemon.v2.DfdaemonUpload.DownloadTask:input_type -> dfdaemon.v2.DownloadTaskRequest
	8,  // 36: dfdaemon.v2.DfdaemonUpload.StatTask:input_type -> dfdaemon.v2.StatTaskRequest
	9,  // 37: dfdaemon.v2.DfdaemonUpload.ListTaskEntries:input_type -> dfdaemon.v2.ListTaskEntriesRequest
	12, // 38: dfdaemon.v2.DfdaemonUpload.DeleteTask:input_type -> dfdaemon.v2.DeleteTaskRequest
	4,  // 39: dfdaemon.v2.DfdaemonUpload.SyncPieces:input_type -> dfdaemon.v2.SyncPiecesRequest
	6,  // 40: dfdaemon.v2.DfdaemonUpload.DownloadPiece:input_type -> dfdaemon.v2.DownloadPieceRequest
	13, // 41: dfdaemon.v2.DfdaemonUpload.DownloadCacheTask:input_type -> dfdaemon.v2.DownloadCacheTaskRequest
	20, // 42: dfdaemon.v2.DfdaemonUpload.StatCacheTask:input_type -> dfdaemon.v2.StatCacheTaskRequest
	21, // 43: dfdaemon.v2.DfdaemonUpload.DeleteCacheTask:input_type -> dfdaemon.v2.DeleteCacheTaskRequest
	16, // 44: dfdaemon.v2.DfdaemonUpload.SyncCachePieces:input_type -> dfdaemon.v2.SyncCachePiecesRequest
	18, // 45: dfdaemon.v2.DfdaemonUpload.DownloadCachePiece:input_type -> dfdaemon.v2.DownloadCachePieceRequest
	22, // 46: dfdaemon.v2.DfdaemonUpload.DownloadPersistentCacheTask:input_type -> dfdaemon.v2.DownloadPersistentCacheTaskRequest
	26, // 47: dfdaemon.v2.DfdaemonUpload.UpdatePersistentCacheTask:input_type -> dfdaemon.v2.UpdatePersistentCacheTaskRequest
	27, // 48: dfdaemon.v2.DfdaemonUpload.StatPersistentCacheTask:input_type -> dfdaemon.v2.StatPersistentCacheTaskRequest
	28, // 49: dfdaemon.v2.DfdaemonUpload.DeletePersistentCacheTask:input_type -> dfdaemon.v2.DeletePersistentCacheTaskRequest
	29, // 50: dfdaemon.v2.DfdaemonUpload.SyncPersistentCachePieces:input_type -> dfdaemon.v2.SyncPersistentCachePiecesRequest
	31, // 51: dfdaemon.v2.DfdaemonUpload.DownloadPersistentCachePiece:input_type -> dfdaemon.v2.DownloadPersistentCachePieceRequest
	33, // 52: dfdaemon.v2.DfdaemonUpload.SyncHost:input_type -> dfdaemon.v2.SyncHostRequest
	35, // 53: dfdaemon.v2.DfdaemonUpload.ExchangeIBVerbsQueuePairEndpoint:input_type -> dfdaemon.v2.ExchangeIBVerbsQueuePairEndpointRequest
	0,  // 54: dfdaemon.v2.DfdaemonDownload.DownloadTask:input_type -> dfdaemon.v2.DownloadTaskRequest
	8,  // 55: dfdaemon.v2.DfdaemonDownload.StatTask:input_type -> dfdaemon.v2.StatTaskRequest
	9,  // 56: dfdaemon.v2.DfdaemonDownload.ListTaskEntries:input_type -> dfdaemon.v2.ListTaskEntriesRequest
	12, // 57: dfdaemon.v2.DfdaemonDownload.DeleteTask:input_type -> dfdaemon.v2.DeleteTaskRequest
	50, // 58: dfdaemon.v2.DfdaemonDownload.DeleteHost:input_type -> google.protobuf.Empty
	13, // 59: dfdaemon.v2.DfdaemonDownload.DownloadCacheTask:input_type -> dfdaemon.v2.DownloadCacheTaskRequest
	20, // 60: dfdaemon.v2.DfdaemonDownload.StatCacheTask:input_type -> dfdaemon.v2.StatCacheTaskRequest
	21, // 61: dfdaemon.v2.DfdaemonDownload.DeleteCacheTask:input_type -> dfdaemon.v2.DeleteCacheTaskRequest
	22, // 62: dfdaemon.v2.DfdaemonDownload.DownloadPersistentCacheTask:input_type -> dfdaemon.v2.DownloadPersistentCacheTaskRequest
	25, // 63: dfdaemon.v2.DfdaemonDownload.UploadPersistentCacheTask:input_type -> dfdaemon.v2.UploadPersistentCacheTaskRequest
	27, // 64: dfdaemon.v2.DfdaemonDownload.StatPersistentCacheTask:input_type -> dfdaemon.v2.StatPersistentCacheTaskRequest
	3,  // 65: dfdaemon.v2.DfdaemonUpload.DownloadTask:output_type -> dfdaemon.v2.DownloadTaskResponse
	51, // 66: dfdaemon.v2.DfdaemonUpload.StatTask:output_type -> common.v2.Task
	10, // 67: dfdaemon.v2.DfdaemonUpload.ListTaskEntries:output_type -> dfdaemon.v2.ListTaskEntriesResponse
	50, // 68: dfdaemon.v2.DfdaemonUpload.DeleteTask:output_type -> google.protobuf.Empty
	5,  // 69: dfdaemon.v2.DfdaemonUpload.SyncPieces:output_type -> dfdaemon.v2.SyncPiecesResponse
	7,  // 70: dfdaemon.v2.DfdaemonUpload.DownloadPiece:output_type -> dfdaemon.v2.DownloadPieceResponse
	15, // 71: dfdaemon.v2.DfdaemonUpload.DownloadCacheTask:output_type -> dfdaemon.v2.DownloadCacheTaskResponse
	52, // 72: dfdaemon.v2.DfdaemonUpload.StatCacheTask:output_type -> common.v2.CacheTask
	50, // 73: dfdaemon.v2.DfdaemonUpload.DeleteCacheTask:output_type -> google.protobuf.Empty
	17, // 74: dfdaemon.v2.DfdaemonUpload.SyncCachePieces:output_type -> dfdaemon.v2.SyncCachePiecesResponse
	19, // 75: dfdaemon.v2.DfdaemonUpload.DownloadCachePiece:output_type -> dfdaemon.v2.DownloadCachePieceResponse
	24, // 76: dfdaemon.v2.DfdaemonUpload.DownloadPersistentCacheTask:output_type -> dfdaemon.v2.DownloadPersistentCacheTaskResponse
	50, // 77: dfdaemon.v2.DfdaemonUpload.UpdatePersistentCacheTask:output_type -> google.protobuf.Empty
	53, // 78: dfdaemon.v2.DfdaemonUpload.StatPersistentCacheTask:output_type -> common.v2.PersistentCacheTask
	50, // 79: dfdaemon.v2.DfdaemonUpload.DeletePersistentCacheTask:output_type -> google.protobuf.Empty
	30, // 80: dfdaemon.v2.DfdaemonUpload.SyncPersistentCachePieces:output_type -> dfdaemon.v2.SyncPersistentCachePiecesResponse
	32, // 81: dfdaemon.v2.DfdaemonUpload.DownloadPersistentCachePiece:output_type -> dfdaemon.v2.DownloadPersistentCachePieceResponse
	54, // 82: dfdaemon.v2.DfdaemonUpload.SyncHost:output_type -> common.v2.Host
	36, // 83: dfdaemon.v2.DfdaemonUpload.ExchangeIBVerbsQueuePairEndpoint:output_type -> dfdaemon.v2.ExchangeIBVerbsQueuePairEndpointResponse
	3,  // 84: dfdaemon.v2.DfdaemonDownload.DownloadTask:output_type -> dfdaemon.v2.DownloadTaskResponse
	51, // 85: dfdaemon.v2.DfdaemonDownload.StatTask:output_type -> common.v2.Task
	10, // 86: dfdaemon.v2.DfdaemonDownload.ListTaskEntries:output_type -> dfdaemon.v2.ListTaskEntriesResponse
	50, // 87: dfdaemon.v2.DfdaemonDownload.DeleteTask:output_type -> google.protobuf.Empty
	50, // 88: dfdaemon.v2.DfdaemonDownload.DeleteHost:output_type -> google.protobuf.Empty
	15, // 89: dfdaemon.v2.DfdaemonDownload.DownloadCacheTask:output_type -> dfdaemon.v2.DownloadCacheTaskResponse
	52, // 90: dfdaemon.v2.DfdaemonDownload.StatCacheTask:output_type -> common.v2.CacheTask
	50, // 91: dfdaemon.v2.DfdaemonDownload.DeleteCacheTask:output_type -> google.protobuf.Empty
	24, // 92: dfdaemon.v2.DfdaemonDownload.DownloadPersistentCacheTask:output_type -> dfdaemon.v2.DownloadPersistentCacheTaskResponse
	53, // 93: dfdaemon.v2.DfdaemonDownload.UploadPersistentCacheTask:output_type -> common.v2.PersistentCacheTask
	53, // 94: dfdaemon.v2.DfdaemonDownload.StatPersistentCacheTask:output_type -> common.v2.PersistentCacheTask
