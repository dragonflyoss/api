...
var file_pkg_apis_scheduler_v2_scheduler_proto_goTypes = []interface{}{
	...
	(*UpdateHostsRequest)(nil),                       // 35: scheduler.v2.UpdateHostsRequest
	(*DeleteHostsRequest)(nil),                       // 36: scheduler.v2.DeleteHostsRequest
	(*SyncNetworkTopologyRequest)(nil),               // 37: scheduler.v2.SyncNetworkTopologyRequest
...
var file_pkg_apis_scheduler_v2_scheduler_proto_depIdxs = []int32{
	...
	44, // 34: scheduler.v2.Probe.updated_at:type_name -> google.protobuf.Timestamp
	42, // 35: scheduler.v2.ProbesOfHost.host:type_name -> common.v2.Host
	...
	42, // 38: scheduler.v2.SyncProbesResponse.hosts:type_name -> common.v2.Host
	43, // 39: scheduler.v2.SyncProbesResponse.probe_interval:type_name -> google.protobuf.Duration
	32, // 40: scheduler.v2.UpdateHostsRequest.probes_of_hosts:type_name -> scheduler.v2.ProbesOfHost
	32, // 41: scheduler.v2.DeleteHostsRequest.probes_of_hosts:type_name -> scheduler.v2.ProbesOfHost
	35, // 42: scheduler.v2.SyncNetworkTopologyRequest.update_probes_of_hosts_request:type_name -> scheduler.v2.UpdateHostsRequest
	36, // 43: scheduler.v2.SyncNetworkTopologyRequest.delete_probes_of_hosts_request:type_name -> scheduler.v2.DeleteHostsRequest
	17, // 44: scheduler.v2.Scheduler.AnnouncePeer:input_type -> scheduler.v2.AnnouncePeerRequest
	24, // 45: scheduler.v2.Scheduler.StatPeer:input_type -> scheduler.v2.StatPeerRequest
	27, // 46: scheduler.v2.Scheduler.LeavePeer:input_type -> scheduler.v2.LeavePeerRequest
	25, // 47: scheduler.v2.Scheduler.ExchangePeer:input_type -> scheduler.v2.ExchangePeerRequest
	28, // 48: scheduler.v2.Scheduler.StatTask:input_type -> scheduler.v2.StatTaskRequest
	29, // 49: scheduler.v2.Scheduler.AnnounceHost:input_type -> scheduler.v2.AnnounceHostRequest
	30, // 50: scheduler.v2.Scheduler.LeaveHost:input_type -> scheduler.v2.LeaveHostRequest
	33, // 51: scheduler.v2.Scheduler.SyncProbes:input_type -> scheduler.v2.SyncProbesRequest
	37, // 52: scheduler.v2.Scheduler.SyncNetworkTopology:input_type -> scheduler.v2.SyncNetworkTopologyRequest
	23, // 53: scheduler.v2.Scheduler.AnnouncePeer:output_type -> scheduler.v2.AnnouncePeerResponse
	41, // 54: scheduler.v2.Scheduler.StatPeer:output_type -> common.v2.Peer
	45, // 55: scheduler.v2.Scheduler.LeavePeer:output_type -> google.protobuf.Empty
	26, // 56: scheduler.v2.Scheduler.ExchangePeer:output_type -> scheduler.v2.ExchangePeerResponse
	46, // 57: scheduler.v2.Scheduler.StatTask:output_type -> common.v2.Task
	45, // 58: scheduler.v2.Scheduler.AnnounceHost:output_type -> google.protobuf.Empty
	45, // 59: scheduler.v2.Scheduler.LeaveHost:output_type -> google.protobuf.Empty
	34, // 60: scheduler.v2.Scheduler.SyncProbes:output_type -> scheduler.v2.SyncProbesResponse
	45, // 61: scheduler.v2.Scheduler.SyncNetworkTopology:output_type -> google.protobuf.Empty
