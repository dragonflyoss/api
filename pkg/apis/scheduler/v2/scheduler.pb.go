...
type AnnouncePeerRequest_DownloadPeerFinishedRequest struct {
	DownloadPeerFinishedRequest *DownloadPeerFinishedRequest `protobuf:"bytes,7,opt,name=download_peer_finished_request,json=downloadPeerFinishedRequest,proto3,oneof"`
}

type AnnouncePeerRequest_DownloadPeerBackToSourceFinishedRequest struct {
	DownloadPeerBackToSourceFinishedRequest *DownloadPeerBackToSourceFinishedRequest `protobuf:"bytes,8,opt,name=download_peer_back_to_source_finished_request,json=downloadPeerBackToSourceFinishedRequest,proto3,oneof"`
}
...
type AnnouncePeerRequest_DownloadPieceBackToSourceFinishedRequest struct {
	DownloadPieceBackToSourceFinishedRequest *DownloadPieceBackToSourceFinishedRequest `protobuf:"bytes,10,opt,name=download_piece_back_to_source_finished_request,json=downloadPieceBackToSourceFinishedRequest,proto3,oneof"`
}

type AnnouncePeerRequest_DownloadPieceFailedRequest struct {
	DownloadPieceFailedRequest *DownloadPieceFailedRequest `protobuf:"bytes,11,opt,name=download_piece_failed_request,json=downloadPieceFailedRequest,proto3,oneof"`
}

type AnnouncePeerRequest_DownloadPieceBackToSourceFailedRequest struct {
	DownloadPieceBackToSourceFailedRequest *DownloadPieceBackToSourceFailedRequest `protobuf:"bytes,12,opt,name=download_piece_back_to_source_failed_request,json=downloadPieceBackToSourceFailedRequest,proto3,oneof"`
}

type AnnouncePeerRequest_SyncPiecesFailedRequest struct {
	SyncPiecesFailedRequest *SyncPiecesFailedRequest `protobuf:"bytes,13,opt,name=sync_pieces_failed_request,json=syncPiecesFailedRequest,proto3,oneof"`
}
...
type SchedulePeerForbiddenResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *SchedulePeerForbiddenResponse) Reset() {
	*x = SchedulePeerForbiddenResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *SchedulePeerForbiddenResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SchedulePeerForbiddenResponse) ProtoMessage() {}

func (x *SchedulePeerForbiddenResponse) ProtoReflect() protoreflect.Message {
	mi := &file_pkg_apis_scheduler_v2_scheduler_proto_msgTypes[15]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SchedulePeerForbiddenResponse.ProtoReflect.Descriptor instead.
func (*SchedulePeerForbiddenResponse) Descriptor() ([]byte, []int) {
	return file_pkg_apis_scheduler_v2_scheduler_proto_rawDescGZIP(), []int{15}
}

func (x *SchedulePeerForbiddenResponse) GetDescription() string {
	if x != nil {
		return x.Description
	}
	return ""
...
type SchedulePeerFailedResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *SchedulePeerFailedResponse) Reset() {
	*x = SchedulePeerFailedResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *SchedulePeerFailedResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SchedulePeerFailedResponse) ProtoMessage() {}

func (x *SchedulePeerFailedResponse) ProtoReflect() protoreflect.Message {
	mi := &file_pkg_apis_scheduler_v2_scheduler_proto_msgTypes[16]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SchedulePeerFailedResponse.ProtoReflect.Descriptor instead.
func (*SchedulePeerFailedResponse) Descriptor() ([]byte, []int) {
	return file_pkg_apis_scheduler_v2_scheduler_proto_rawDescGZIP(), []int{16}
}

func (x *SchedulePeerFailedResponse) GetDescription() string {
	if x != nil {
		return x.Description
	}
	return ""
...
type AnnouncePeerResponse struct {
	...
	//	*AnnouncePeerResponse_SchedulePeerForbiddenResponse
	//	*AnnouncePeerResponse_SchedulePeerFailedResponse
...
func (x *AnnouncePeerResponse) GetSchedulePeerForbiddenResponse() *SchedulePeerForbiddenResponse {
	if x, ok := x.GetResponse().(*AnnouncePeerResponse_SchedulePeerForbiddenResponse); ok {
		return x.SchedulePeerForbiddenResponse
	}
	return nil
}

func (x *AnnouncePeerResponse) GetSchedulePeerFailedResponse() *SchedulePeerFailedResponse {
	if x, ok := x.GetResponse().(*AnnouncePeerResponse_SchedulePeerFailedResponse); ok {
		return x.SchedulePeerFailedResponse
	}
	return nil
}
...
type AnnouncePeerResponse_SchedulePeerForbiddenResponse struct {
	SchedulePeerForbiddenResponse *SchedulePeerForbiddenResponse `protobuf:"bytes,5,opt,name=schedule_peer_forbidden_response,json=schedulePeerForbiddenResponse,proto3,oneof"`
}

type AnnouncePeerResponse_SchedulePeerFailedResponse struct {
	SchedulePeerFailedResponse *SchedulePeerFailedResponse `protobuf:"bytes,6,opt,name=schedule_peer_failed_response,json=schedulePeerFailedResponse,proto3,oneof"`
}
...
func (*AnnouncePeerResponse_SchedulePeerForbiddenResponse) isAnnouncePeerResponse_Response() {}

func (*AnnouncePeerResponse_SchedulePeerFailedResponse) isAnnouncePeerResponse_Response() {}
...
var file_pkg_apis_scheduler_v2_scheduler_proto_rawDesc = []byte{
	...
	0x1c, 0x0a, 0x1a, 0x44, 0x6f, 0x77, 0x6e, 0x6c, 0x6f, 0x61, 0x64, 0x50, 0x65, 0x65, 0x72, 0x53,
	0x74, 0x61, 0x72, 0x74, 0x65, 0x64, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x49, 0x0a,
	0x26, 0x44, 0x6f, 0x77, 0x6e, 0x6c, 0x6f, 0x61, 0x64, 0x50, 0x65, 0x65, 0x72, 0x42, 0x61, 0x63,
	0x6b, 0x54, 0x6f, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x53, 0x74, 0x61, 0x72, 0x74, 0x65, 0x64,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1f, 0x0a, 0x06, 0x72, 0x65, 0x61, 0x73, 0x6f,
	0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x42, 0x07, 0xfa, 0x42, 0x04, 0x72, 0x02, 0x10, 0x01,
	0x52, 0x06, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x22, 0x77, 0x0a, 0x1b, 0x44, 0x6f, 0x77, 0x6e,
	...
	0x63, 0x65, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x50, 0x0a, 0x1c, 0x44, 0x6f, 0x77, 0x6e, 0x6c,
	...
	,
	...
	0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x12, 0x2b, 0x0a, 0x0b, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73,
	0x5f, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x05, 0x42, 0x0a, 0xfa, 0x42, 0x07,
	0x1a, 0x05, 0x10, 0xd7, 0x04, 0x28, 0x64, 0x52, 0x0a, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x43,
	0x6f, 0x64, 0x65, 0x12, 0x1f, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x05, 0x20,
	...
	0xb7, 0x02, 0x0a, 0x26, 0x44, 0x6f, 0x77, 0x6e, 0x6c, 0x6f, 0x61, 0x64, 0x50, 0x69, 0x65, 0x63,
	0x65, 0x42, 0x61, 0x63, 0x6b, 0x54, 0x6f, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x46, 0x61, 0x69,
	0x6c, 0x65, 0x64, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x2a, 0x0a, 0x0c, 0x70, 0x69,
	...
	0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x12, 0x58, 0x0a, 0x06, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72,
	0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x40, 0x2e, 0x73, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c,
	...
	,
	...
	0x0b, 0x64, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0xf4, 0x0a, 0x0a,
	...
	0x65, 0x64, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x70, 0x0a, 0x1e, 0x64, 0x6f, 0x77,
	0x6e, 0x6c, 0x6f, 0x61, 0x64, 0x5f, 0x70, 0x65, 0x65, 0x72, 0x5f, 0x66, 0x69, 0x6e, 0x69, 0x73,
	...
	0x2e, 0x44, 0x6f, 0x77, 0x6e, 0x6c, 0x6f, 0x61, 0x64, 0x50, 0x65, 0x65, 0x72, 0x46, 0x69, 0x6e,
	0x69, 0x73, 0x68, 0x65, 0x64, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x48, 0x00, 0x52, 0x1b,
	0x64, 0x6f, 0x77, 0x6e, 0x6c, 0x6f, 0x61, 0x64, 0x50, 0x65, 0x65, 0x72, 0x46, 0x69, 0x6e, 0x69,
	0x73, 0x68, 0x65, 0x64, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x97, 0x01, 0x0a, 0x2d,
	...
	0x01, 0x28, 0x0b, 0x32, 0x35, 0x2e, 0x73, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x72, 0x2e,
	...
	0x68, 0x65, 0x64, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x48, 0x00, 0x52, 0x27, 0x64, 0x6f,
	...
	0x63, 0x6b, 0x5f, 0x74, 0x6f, 0x5f, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f, 0x66, 0x69, 0x6e,
	0x69, 0x73, 0x68, 0x65, 0x64, 0x5f, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x18, 0x0a, 0x20,
	...
	0x5f, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x28,
	0x2e, 0x73, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x72, 0x2e, 0x76, 0x32, 0x2e, 0x44, 0x6f,
	...
	0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x34, 0x2e,
	...
	,
	...
	0x01, 0x02, 0x10, 0x01, 0x52, 0x05, 0x70, 0x69, 0x65, 0x63, 0x65, 0x22, 0x9b, 0x01, 0x0a, 0x12,
	0x4e, 0x6f, 0x72, 0x6d, 0x61, 0x6c, 0x54, 0x61, 0x73, 0x6b, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x12, 0x46, 0x0a, 0x11, 0x63, 0x61, 0x6e, 0x64, 0x69, 0x64, 0x61, 0x74, 0x65, 0x5f,
	0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0f, 0x2e,
	0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x76, 0x32, 0x2e, 0x50, 0x65, 0x65, 0x72, 0x42, 0x08,
	0xfa, 0x42, 0x05, 0x92, 0x01, 0x02, 0x08, 0x01, 0x52, 0x10, 0x63, 0x61, 0x6e, 0x64, 0x69, 0x64,
	0x61, 0x74, 0x65, 0x50, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x73, 0x12, 0x3d, 0x0a, 0x16, 0x63, 0x6f,
	...
	0x02, 0x28, 0x01, 0x52, 0x14, 0x63, 0x6f, 0x6e, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x50,
	0x69, 0x65, 0x63, 0x65, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x3b, 0x0a, 0x18, 0x4e, 0x65, 0x65,
	0x64, 0x42, 0x61, 0x63, 0x6b, 0x54, 0x6f, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x1f, 0x0a, 0x06, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x09, 0x42, 0x07, 0xfa, 0x42, 0x04, 0x72, 0x02, 0x10, 0x01, 0x52, 0x06,
	0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x22, 0x41, 0x0a, 0x1d, 0x53, 0x63, 0x68, 0x65, 0x64, 0x75,
	0x6c, 0x65, 0x50, 0x65, 0x65, 0x72, 0x46, 0x6f, 0x72, 0x62, 0x69, 0x64, 0x64, 0x65, 0x6e, 0x52,
	...
	0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x3e, 0x0a, 0x1a, 0x53, 0x63, 0x68,
	0x65, 0x64, 0x75, 0x6c, 0x65, 0x50, 0x65, 0x65, 0x72, 0x46, 0x61, 0x69, 0x6c, 0x65, 0x64, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x20, 0x0a, 0x0b, 0x64, 0x65, 0x73, 0x63, 0x72,
	0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x64, 0x65,
	0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0xf1, 0x04, 0x0a, 0x14, 0x41, 0x6e,
	...
	,
	...
	0x65, 0x72, 0x49, 0x64, 0x22, 0x59, 0x0a, 0x13, 0x45, 0x78, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65,
	...
	,
	...
	0x74, 0x22, 0x2b, 0x0a, 0x10, 0x4c, 0x65, 0x61, 0x76, 0x65, 0x48, 0x6f, 0x73, 0x74, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x17, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x42, 0x07, 0xfa, 0x42, 0x04, 0x72, 0x02, 0x10, 0x01, 0x52, 0x02, 0x69, 0x64, 0x22, 0xb2,
	...
	0x64, 0x41, 0x74, 0x22, 0x76, 0x0a, 0x0c, 0x50, 0x72, 0x6f, 0x62, 0x65, 0x73, 0x4f, 0x66, 0x48,
	0x6f, 0x73, 0x74, 0x12, 0x2d, 0x0a, 0x04, 0x68, 0x6f, 0x73, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28,
	...
	,
	...
	0x05, 0x68, 0x6f, 0x73, 0x74, 0x73, 0x12, 0x4a, 0x0a, 0x0e, 0x70, 0x72, 0x6f, 0x62, 0x65, 0x5f,
	...
	,
	...
	0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x76, 0x32, 0x2e, 0x50, 0x65, 0x65, 0x72, 0x12, 0x43,
	0x0a, 0x09, 0x4c, 0x65, 0x61, 0x76, 0x65, 0x50, 0x65, 0x65, 0x72, 0x12, 0x1e, 0x2e, 0x73, 0x63,
	...
	0x70, 0x74, 0x79, 0x12, 0x55, 0x0a, 0x0c, 0x45, 0x78, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x50,
	0x65, 0x65, 0x72, 0x12, 0x21, 0x2e, 0x73, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x72, 0x2e,
	0x76, 0x32, 0x2e, 0x45, 0x78, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x50, 0x65, 0x65, 0x72, 0x52,
	...
	0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x3a, 0x0a, 0x08, 0x53, 0x74,
	...
	0x32, 0x2e, 0x54, 0x61, 0x73, 0x6b, 0x12, 0x49, 0x0a, 0x0c, 0x41, 0x6e, 0x6e, 0x6f, 0x75, 0x6e,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x28, 0x01, 0x30, 0x01, 0x12, 0x59, 0x0a, 0x13, 0x53,
	0x79, 0x6e, 0x63, 0x4e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x54, 0x6f, 0x70, 0x6f, 0x6c, 0x6f,
	0x67, 0x79, 0x12, 0x28, 0x2e, 0x73, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x72, 0x2e, 0x76,
	0x32, 0x2e, 0x53, 0x79, 0x6e, 0x63, 0x4e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x54, 0x6f, 0x70,
...
var file_pkg_apis_scheduler_v2_scheduler_proto_goTypes = []interface{}{
	...
	(*DownloadPieceFailedRequest)(nil),               // 7: scheduler.v2.DownloadPieceFailedRequest
	(*DownloadPieceBackToSourceFailedRequest)(nil),   // 8: scheduler.v2.DownloadPieceBackToSourceFailedRequest
	(*SyncPiecesFailedRequest)(nil),                  // 9: scheduler.v2.SyncPiecesFailedRequest
	(*AnnouncePeerRequest)(nil),                      // 10: scheduler.v2.AnnouncePeerRequest
	(*TinyTaskResponse)(nil),                         // 11: scheduler.v2.TinyTaskResponse
	(*SmallTaskResponse)(nil),                        // 12: scheduler.v2.SmallTaskResponse
	(*NormalTaskResponse)(nil),                       // 13: scheduler.v2.NormalTaskResponse
	(*NeedBackToSourceResponse)(nil),                 // 14: scheduler.v2.NeedBackToSourceResponse
	(*SchedulePeerForbiddenResponse)(nil),            // 15: scheduler.v2.SchedulePeerForbiddenResponse
	(*SchedulePeerFailedResponse)(nil),               // 16: scheduler.v2.SchedulePeerFailedResponse
	(*AnnouncePeerResponse)(nil),                     // 17: scheduler.v2.AnnouncePeerResponse
	(*StatPeerRequest)(nil),                          // 18: scheduler.v2.StatPeerRequest
	(*ExchangePeerRequest)(nil),                      // 19: scheduler.v2.ExchangePeerRequest
	(*ExchangePeerResponse)(nil),                     // 20: scheduler.v2.ExchangePeerResponse
	(*LeavePeerRequest)(nil),                         // 21: scheduler.v2.LeavePeerRequest
	(*StatTaskRequest)(nil),                          // 22: scheduler.v2.StatTaskRequest
	...
	(*ProbesOfHost)(nil),                             // 26: scheduler.v2.ProbesOfHost
	(*SyncProbesRequest)(nil),                        // 27: scheduler.v2.SyncProbesRequest
	(*SyncProbesResponse)(nil),                       // 28: scheduler.v2.SyncProbesResponse
	(*UpdateHostsRequest)(nil),                       // 29: scheduler.v2.UpdateHostsRequest
	(*DeleteHostsRequest)(nil),                       // 30: scheduler.v2.DeleteHostsRequest
	(*SyncNetworkTopologyRequest)(nil),               // 31: scheduler.v2.SyncNetworkTopologyRequest
	nil,                                              // 32: scheduler.v2.DownloadPieceFailedRequest.HeaderEntry
	nil,                                              // 33: scheduler.v2.DownloadPieceBackToSourceFailedRequest.HeaderEntry
...
var file_pkg_apis_scheduler_v2_scheduler_proto_depIdxs = []int32{
	...
	35, // 1: scheduler.v2.DownloadPieceFinishedRequest.piece:type_name -> common.v2.Piece
	35, // 2: scheduler.v2.DownloadPieceBackToSourceFinishedRequest.piece:type_name -> common.v2.Piece
	32, // 3: scheduler.v2.DownloadPieceFailedRequest.header:type_name -> scheduler.v2.DownloadPieceFailedRequest.HeaderEntry
	33, // 4: scheduler.v2.DownloadPieceBackToSourceFailedRequest.header:type_name -> scheduler.v2.DownloadPieceBackToSourceFailedRequest.HeaderEntry
	...
	3,  // 8: scheduler.v2.AnnouncePeerRequest.download_peer_finished_request:type_name -> scheduler.v2.DownloadPeerFinishedRequest
	4,  // 9: scheduler.v2.AnnouncePeerRequest.download_peer_back_to_source_finished_request:type_name -> scheduler.v2.DownloadPeerBackToSourceFinishedRequest
	5,  // 10: scheduler.v2.AnnouncePeerRequest.download_piece_finished_request:type_name -> scheduler.v2.DownloadPieceFinishedRequest
	6,  // 11: scheduler.v2.AnnouncePeerRequest.download_piece_back_to_source_finished_request:type_name -> scheduler.v2.DownloadPieceBackToSourceFinishedRequest
	7,  // 12: scheduler.v2.AnnouncePeerRequest.download_piece_failed_request:type_name -> scheduler.v2.DownloadPieceFailedRequest
	8,  // 13: scheduler.v2.AnnouncePeerRequest.download_piece_back_to_source_failed_request:type_name -> scheduler.v2.DownloadPieceBackToSourceFailedRequest
	9,  // 14: scheduler.v2.AnnouncePeerRequest.sync_pieces_failed_request:type_name -> scheduler.v2.SyncPiecesFailedRequest
	35, // 15: scheduler.v2.SmallTaskResponse.piece:type_name -> common.v2.Piece
	36, // 16: scheduler.v2.NormalTaskResponse.candidate_parents:type_name -> common.v2.Peer
	11, // 17: scheduler.v2.AnnouncePeerResponse.tiny_task_response:type_name -> scheduler.v2.TinyTaskResponse
	12, // 18: scheduler.v2.AnnouncePeerResponse.small_task_response:type_name -> scheduler.v2.SmallTaskResponse
	13, // 19: scheduler.v2.AnnouncePeerResponse.normal_task_response:type_name -> scheduler.v2.NormalTaskResponse
	14, // 20: scheduler.v2.AnnouncePeerResponse.need_back_to_source_response:type_name -> scheduler.v2.NeedBackToSourceResponse
	15, // 21: scheduler.v2.AnnouncePeerResponse.schedule_peer_forbidden_response:type_name -> scheduler.v2.SchedulePeerForbiddenResponse
	16, // 22: scheduler.v2.AnnouncePeerResponse.schedule_peer_failed_response:type_name -> scheduler.v2.SchedulePeerFailedResponse
	...
	39, // 26: scheduler.v2.Probe.updated_at:type_name -> google.protobuf.Timestamp
	37, // 27: scheduler.v2.ProbesOfHost.host:type_name -> common.v2.Host
	25, // 28: scheduler.v2.ProbesOfHost.probes:type_name -> scheduler.v2.Probe
	26, // 29: scheduler.v2.SyncProbesRequest.probes_of_host:type_name -> scheduler.v2.ProbesOfHost
	37, // 30: scheduler.v2.SyncProbesResponse.hosts:type_name -> common.v2.Host
	38, // 31: scheduler.v2.SyncProbesResponse.probe_interval:type_name -> google.protobuf.Duration
	26, // 32: scheduler.v2.UpdateHostsRequest.probes_of_hosts:type_name -> scheduler.v2.ProbesOfHost
	26, // 33: scheduler.v2.DeleteHostsRequest.probes_of_hosts:type_name -> scheduler.v2.ProbesOfHost
	29, // 34: scheduler.v2.SyncNetworkTopologyRequest.update_probes_of_hosts_request:type_name -> scheduler.v2.UpdateHostsRequest
	30, // 35: scheduler.v2.SyncNetworkTopologyRequest.delete_probes_of_hosts_request:type_name -> scheduler.v2.DeleteHostsRequest
	10, // 36: scheduler.v2.Scheduler.AnnouncePeer:input_type -> scheduler.v2.AnnouncePeerRequest
	18, // 37: scheduler.v2.Scheduler.StatPeer:input_type -> scheduler.v2.StatPeerRequest
	21, // 38: scheduler.v2.Scheduler.LeavePeer:input_type -> scheduler.v2.LeavePeerRequest
	19, // 39: scheduler.v2.Scheduler.ExchangePeer:input_type -> scheduler.v2.ExchangePeerRequest
	22, // 40: scheduler.v2.Scheduler.StatTask:input_type -> scheduler.v2.StatTaskRequest
	23, // 41: scheduler.v2.Scheduler.AnnounceHost:input_type -> scheduler.v2.AnnounceHostRequest
	24, // 42: scheduler.v2.Scheduler.LeaveHost:input_type -> scheduler.v2.LeaveHostRequest
	27, // 43: scheduler.v2.Scheduler.SyncProbes:input_type -> scheduler.v2.SyncProbesRequest
	31, // 44: scheduler.v2.Scheduler.SyncNetworkTopology:input_type -> scheduler.v2.SyncNetworkTopologyRequest
	17, // 45: scheduler.v2.Scheduler.AnnouncePeer:output_type -> scheduler.v2.AnnouncePeerResponse
	36, // 46: scheduler.v2.Scheduler.StatPeer:output_type -> common.v2.Peer
	40, // 47: scheduler.v2.Scheduler.LeavePeer:output_type -> google.protobuf.Empty
	20, // 48: scheduler.v2.Scheduler.ExchangePeer:output_type -> scheduler.v2.ExchangePeerResponse
	41, // 49: scheduler.v2.Scheduler.StatTask:output_type -> common.v2.Task
	40, // 50: scheduler.v2.Scheduler.AnnounceHost:output_type -> google.protobuf.Empty
	40, // 51: scheduler.v2.Scheduler.LeaveHost:output_type -> google.protobuf.Empty
	28, // 52: scheduler.v2.Scheduler.SyncProbes:output_type -> scheduler.v2.SyncProbesResponse
	40, // 53: scheduler.v2.Scheduler.SyncNetworkTopology:output_type -> google.protobuf.Empty
...
func file_pkg_apis_scheduler_v2_scheduler_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pkg_apis_scheduler_v2_scheduler_proto_msgTypes[15].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SchedulePeerForbiddenResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_pkg_apis_scheduler_v2_scheduler_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SchedulePeerFailedResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_pkg_apis_scheduler_v2_scheduler_proto_msgTypes[17].OneofWrappers = []interface{}{
		...
		(*AnnouncePeerResponse_SchedulePeerForbiddenResponse)(nil),
		(*AnnouncePeerResponse_SchedulePeerFailedResponse)(nil),
	}
