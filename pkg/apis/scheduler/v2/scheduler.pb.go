...
var file_pkg_apis_scheduler_v2_scheduler_proto_rawDesc = []byte{
	...
	0x06, 0x74, 0x61, 0x73, 0x6b, 0x49, 0x64, 0x12, 0x20, 0x0a, 0x07, 0x70, 0x65, 0x65, 0x72, 0x5f,
	0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x42, 0x07, 0xfa, 0x42, 0x04, 0x72, 0x02, 0x10,
	0x01, 0x52, 0x06, 0x70, 0x65, 0x65, 0x72, 0x49, 0x64, 0x22, 0x38, 0x0a, 0x14, 0x53, 0x74, 0x61,
	...
	0x64, 0x32, 0xf5, 0x07, 0x0a, 0x09, 0x53, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x72, 0x12,
	...
	0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x12, 0x45, 0x0a, 0x0a, 0x44,
	...
	0x6e, 0x73, 0x65, 0x28, 0x01, 0x30, 0x01, 0x12, 0x68, 0x0a, 0x11, 0x41, 0x6e, 0x6e, 0x6f, 0x75,
...
var file_pkg_apis_scheduler_v2_scheduler_proto_msgTypes = make([]protoimpl.MessageInfo, 43)
var file_pkg_apis_scheduler_v2_scheduler_proto_goTypes = []interface{}{
	...
	(*StatCacheTaskRequest)(nil),                     // 41: scheduler.v2.StatCacheTaskRequest
	(*DeleteCacheTaskRequest)(nil),                   // 42: scheduler.v2.DeleteCacheTaskRequest
	(*v2.Download)(nil),                              // 43: common.v2.Download
	(*v2.Peer)(nil),                                  // 44: common.v2.Peer
	(*v2.Piece)(nil),                                 // 45: common.v2.Piece
	(*v21.Backend)(nil),                              // 46: errordetails.v2.Backend
	(*v2.Host)(nil),                                  // 47: common.v2.Host
	(*durationpb.Duration)(nil),                      // 48: google.protobuf.Duration
	(*timestamppb.Timestamp)(nil),                    // 49: google.protobuf.Timestamp
	(*v2.CachePeer)(nil),                             // 50: common.v2.CachePeer
	(*emptypb.Empty)(nil),                            // 51: google.protobuf.Empty
	(*v2.Task)(nil),                                  // 52: common.v2.Task
	(*v2.CacheTask)(nil),                             // 53: common.v2.CacheTask
}
var file_pkg_apis_scheduler_v2_scheduler_proto_depIdxs = []int32{
	43, // 0: scheduler.v2.RegisterPeerRequest.download:type_name -> common.v2.Download
	44, // 1: scheduler.v2.ReschedulePeerRequest.candidate_parents:type_name -> common.v2.Peer
	45, // 2: scheduler.v2.DownloadPieceFinishedRequest.piece:type_name -> common.v2.Piece
	45, // 3: scheduler.v2.DownloadPieceBackToSourceFinishedRequest.piece:type_name -> common.v2.Piece
	46, // 4: scheduler.v2.DownloadPieceBackToSourceFailedRequest.backend:type_name -> errordetails.v2.Backend
	...
	44, // 17: scheduler.v2.NormalTaskResponse.candidate_parents:type_name -> common.v2.Peer
	...
	47, // 21: scheduler.v2.AnnounceHostRequest.host:type_name -> common.v2.Host
	47, // 22: scheduler.v2.Probe.host:type_name -> common.v2.Host
	48, // 23: scheduler.v2.Probe.rtt:type_name -> google.protobuf.Duration
	49, // 24: scheduler.v2.Probe.created_at:type_name -> google.protobuf.Timestamp
	24, // 25: scheduler.v2.ProbeFinishedRequest.probes:type_name -> scheduler.v2.Probe
	47, // 26: scheduler.v2.FailedProbe.host:type_name -> common.v2.Host
	26, // 27: scheduler.v2.ProbeFailedRequest.probes:type_name -> scheduler.v2.FailedProbe
	47, // 28: scheduler.v2.SyncProbesRequest.host:type_name -> common.v2.Host
	...
	47, // 32: scheduler.v2.SyncProbesResponse.hosts:type_name -> common.v2.Host
	48, // 33: scheduler.v2.RegisterCachePeerRequest.timeout:type_name -> google.protobuf.Duration
	50, // 34: scheduler.v2.RescheduleCachePeerRequest.candidate_parents:type_name -> common.v2.CachePeer
	...
	50, // 42: scheduler.v2.NormalCacheTaskResponse.candidate_parents:type_name -> common.v2.CachePeer
	...
	12, // 45: scheduler.v2.Scheduler.AnnouncePeer:input_type -> scheduler.v2.AnnouncePeerRequest
	17, // 46: scheduler.v2.Scheduler.StatPeer:input_type -> scheduler.v2.StatPeerRequest
	18, // 47: scheduler.v2.Scheduler.DeletePeer:input_type -> scheduler.v2.DeletePeerRequest
	19, // 48: scheduler.v2.Scheduler.StatTask:input_type -> scheduler.v2.StatTaskRequest
	20, // 49: scheduler.v2.Scheduler.DeleteTask:input_type -> scheduler.v2.DeleteTaskRequest
	21, // 50: scheduler.v2.Scheduler.AnnounceHost:input_type -> scheduler.v2.AnnounceHostRequest
	22, // 51: scheduler.v2.Scheduler.DeleteHost:input_type -> scheduler.v2.DeleteHostRequest
	28, // 52: scheduler.v2.Scheduler.SyncProbes:input_type -> scheduler.v2.SyncProbesRequest
	35, // 53: scheduler.v2.Scheduler.AnnounceCachePeer:input_type -> scheduler.v2.AnnounceCachePeerRequest
	39, // 54: scheduler.v2.Scheduler.StatCachePeer:input_type -> scheduler.v2.StatCachePeerRequest
	40, // 55: scheduler.v2.Scheduler.DeleteCachePeer:input_type -> scheduler.v2.DeleteCachePeerRequest
	41, // 56: scheduler.v2.Scheduler.StatCacheTask:input_type -> scheduler.v2.StatCacheTaskRequest
	42, // 57: scheduler.v2.Scheduler.DeleteCacheTask:input_type -> scheduler.v2.DeleteCacheTaskRequest
	16, // 58: scheduler.v2.Scheduler.AnnouncePeer:output_type -> scheduler.v2.AnnouncePeerResponse
	44, // 59: scheduler.v2.Scheduler.StatPeer:output_type -> common.v2.Peer
	51, // 60: scheduler.v2.Scheduler.DeletePeer:output_type -> google.protobuf.Empty
	52, // 61: scheduler.v2.Scheduler.StatTask:output_type -> common.v2.Task
	51, // 62: scheduler.v2.Scheduler.DeleteTask:output_type -> google.protobuf.Empty
	51, // 63: scheduler.v2.Scheduler.AnnounceHost:output_type -> google.protobuf.Empty
	51, // 64: scheduler.v2.Scheduler.DeleteHost:output_type -> google.protobuf.Empty
	29, // 65: scheduler.v2.Scheduler.SyncProbes:output_type -> scheduler.v2.SyncProbesResponse
	38, // 66: scheduler.v2.Scheduler.AnnounceCachePeer:output_type -> scheduler.v2.AnnounceCachePeerResponse
	50, // 67: scheduler.v2.Scheduler.StatCachePeer:output_type -> common.v2.CachePeer
	51, // 68: scheduler.v2.Scheduler.DeleteCachePeer:output_type -> google.protobuf.Empty
	53, // 69: scheduler.v2.Scheduler.StatCacheTask:output_type -> common.v2.CacheTask
	51, // 70: scheduler.v2.Scheduler.DeleteCacheTask:output_type -> google.protobuf.Empty
